...
CMD ["java", "-jar", "swagger-codegen.jar", "generate", "-i", "swagger.yaml", "-l", "typescript-angular2"]
#java -jar swagger-codegen.jar generate i swagger.yaml -l typescript-angular2